...
public class HillClimbingSearch extends NodeExpander implements Search {
	...
	public static int get_visitados() {
		return visitados;
	}

	public static void set_visitados() {
		visitados += 1;
	}
	...
	private Node getHighestValuedNodeFrom(List children, Problem p) {
		...
		// segun carli double highestValue = -Integer.MAX_VALUE;//
		// Double.MIN_VALUE;
		double highestValue = -Double.MAX_VALUE;// Double.MIN_VALUE;
